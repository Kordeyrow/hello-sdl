...
namespace Lesson04 
{
	...
	bool loop() 
	{
		...
		SDL_SetRenderDrawColor(renderer, 55, 155, 255, 255);
	...
	bool init() 
	{
		...
		window = SDL_CreateWindow("Example", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 540, 360, SDL_WINDOW_SHOWN);
		if (!window) {
